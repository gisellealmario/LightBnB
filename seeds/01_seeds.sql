...
VALUES (1, 'Eva Stanley', 'sebastianguerra@ymail.com', 'password'),
(2, 'Louisa Meyer', 'jacksonrose@hotmail.com', 'password'),
(3, 'Dominic Parks', 'victoriablackwell@outlook.com', 'password');
